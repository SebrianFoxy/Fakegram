...
/// Adds pattern-matching-related methods to [ChatUserEntity].
extension ChatUserEntityPatterns on ChatUserEntity {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ChatUserEntity value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ChatUserEntity() when $default != null:
