...
class _MessageRemoteDatasource implements MessageRemoteDatasource {
  ...
  Future<MessageDeleteResponseDTO> deleteMessage(
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<MessageDeleteResponseDTO>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late MessageDeleteResponseDTO _value;
    try {
      _value = MessageDeleteResponseDTO.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<EditMessageResponseDTO> editMessage(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(request);
    final _options = _setStreamType<EditMessageResponseDTO>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late EditMessageResponseDTO _value;
    try {
      _value = EditMessageResponseDTO.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
