...
class _ChatRemoteDatasource implements ChatRemoteDatasource {
  ...
  Future<ChatResponseDTO> getChats(String accept, String authorization) async {
    ...
    final _options = _setStreamType<ChatResponseDTO>(
  ...
  Future<ChatGroupResponseDTO> createGroupChat(
    ...
    _headers.removeWhere((k, v) => v == null);
    final _data = request;
    final _options = _setStreamType<ChatGroupResponseDTO>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ChatGroupResponseDTO _value;
    try {
      _value = ChatGroupResponseDTO.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
