...
/// Adds pattern-matching-related methods to [MessageRequestDTO].
extension MessageRequestDTOPatterns on MessageRequestDTO {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_MessageRequestDTO value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _MessageRequestDTO() when $default != null:
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _MessageRequestDTO() when $default != null:
        return $default(_that.chatId, _that.message, _that.messageType,
            _that.receiverId, _that.replyToMessageId);
      case _:
        return orElse();
    }
  }
